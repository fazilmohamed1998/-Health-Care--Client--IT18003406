...
public class PaymentAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String output = paymentObj.insertPayment(request.getParameter("paymentID"),
				request.getParameter("paymentReference"), request.getParameter("paymentMethod"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		...
		String output = paymentObj.updatePayment(paras.get("hidPaymentIDSave").toString(),
				paras.get("paymentID").toString(), paras.get("paymentReference").toString(),
				paras.get("paymentMethod").toString(), paras.get("paymentDate").toString());
		response.getWriter().write(output);
	}
